...
export default function Profile() {
  ...
  const save = async () => {
    ...
    try {
      const res = await updateProfile({ email, name: formatted });
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", position: "relative", zIndex: 0, marginTop: 60 }}>
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
          <div>
            ...
            <div style={{ marginTop: 6, color: "#6b7280" }}>Update your display name and view your account info.</div>
          </div>
        ...
        >
          ...
          <div style={{ display: "grid", gap: 14 }}>
            <div style={{ marginTop: 19 }}>
              ...
              <div style={{ marginTop: 6, fontSize: 12, color: "#9ca3af" }}>This is what shows on the dashboard greeting.</div>
            </div>
            ...
            <div style={{ display: "grid", gap: 6, padding: 14, borderRadius: 14, background: "#f9fafb", border: "1px solid #e5e7eb" }}>
              ...
              <input value={email} readOnly style={{ ...inputStyle, background: "#07070715", color: "#1b191970" }} />
              ...
              <div style={{ position: "relative", marginTop: 8 }}>
                ...
                />
                <button type="button" onClick={() => setShowCurrent((v) => !v)} style={showPassBtn}>
              ...
              <div style={{ position: "relative", marginTop: 12 }}>
                ...
                />
                <button type="button" onClick={() => setShowNew((v) => !v)} style={showPassBtn}>
                  {showNew ? "Hide" : "Show"}
                </button>
              </div>
              ...
              <div style={{ position: "relative", marginTop: 12 }}>
                ...
                />
                <button type="button" onClick={() => setShowConfirm((v) => !v)} style={showPassBtn}>
                  {showConfirm ? "Hide" : "Show"}
                </button>
              </div>

              <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 14 }}>
                <button className="btnDanger" type="button" onClick={changePasswordHandler}>
                  Update password
                </button>
              </div>
            </div>
